...
public abstract class DABaseItemInventoryTile extends TileEntity {
    ...
    protected static class ItemStackHandlerTF extends ItemStackHandler {
        private final DABaseItemInventoryTile tile;

        public ItemStackHandlerTF(DABaseItemInventoryTile inv) {
